import { motion } from 'framer-motion';
 ...
 const projects = [ {
    ...
    live: 'https://livingspringsrentals.netlify.app', image: '/assets/hostel2.jpg' },
     { id: 2, title: 'client acquisition system website', 
        description: 'A responsive business website built for Unify Studios to showcase digital services and a client acquisition system. Designed with a clean UI, smooth navigation, and modern frontend technologies to help businesses easily explore services and get started.',
         tags: ['css', 'html','react','javascript'], github: 'https://github.com/moyinoluwabalogun2/unify-studios', 
         live: 'https://unifystudios.netlify.app',
